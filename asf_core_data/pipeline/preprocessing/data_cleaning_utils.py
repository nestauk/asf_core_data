# File: asf_core_data/pipeline/preprocessing/data_cleaning_utils.py
"""Helpers for data cleaning, for example mapping dictionaries."""
...
numeric_features = [
    ...
    "WINDOWS_ENV_EFF_SCORE",
    "MAINHEAT_ENERGY_EFF_SCORE",
    "MAINHEAT_ENV_EFF_SCORE",
    "MAINHEATC_ENERGY_EFF_SCORE",
    "MAINHEATC_ENV_EFF_SCORE",
    "HOT_WATER_ENERGY_EFF_SCORE",
    "HOT_WATER_ENV_EFF_SCORE",
    "LIGHTING_ENERGY_EFF_SCORE",
    "LIGHTING_ENV_EFF_SCORE",
    "AIR_TIGHTNESS_ENERGY_EFF_SCORE",
    "AIR_TIGHTNESS_ENV_EFF_SCORE",
    # Scotland features
